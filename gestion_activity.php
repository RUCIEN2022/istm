                    ...
                    <div class="col-md-12 col-sm-12 ">
                        <div class="dashboard_graph">
                            <div class="row x_title">
                                <div class="col-md-6">
                                    <h4>Gestionnaire des activités</h4>
                                </div>
                            </div>
                                    ...
                                    <div class="card-group">
                                        <div class="card">
                                            <div class="card-header bg-white">
                                                <h2 class="text-dark" style="font-weight:bold;"><span class="btn btn-round bg-primary text-light"><i class="fa fa-send-o"></i></span> Activiités</h2>
                                            </div>
                                            <div class="card-body bg-light" style="overflow: scroll;height: 350px;">
                                                <button type="button" class="btn btn-sm btn-round btn-primary" data-toggle="modal" data-target=".bs-example-modal-lg">Créer une activité</button>
            ...
            <div class="modal-content">
                <div class="modal-header bg-info">
                    <span class="font-weight-bold">
                        <h3 class="text-light font-weight-bold"> Créer une nouvelle activité</h3>
                    </span>
                    <hr>
